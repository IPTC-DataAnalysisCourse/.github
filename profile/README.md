...
- **PCA**: ([LC-MS](https://colab.research.google.com/drive/1SJWei26FEknZ5SK9S-QXMkt3_rj-Pief?authuser=2#scrollTo=Rm4p-4aJeUzD), [NMR](https://colab.research.google.com/drive/1b5VfXCL9P-ym9LegtQnufqNeT0VfDZz5?usp=sharing))
...
### Thursday 
- **PLS-DA and OPLS**: ([LC-MS](https://colab.research.google.com/drive/15SDmiZsnsIdDXR7yJW9Jp70PGMp_iGie?authuser=1&pli=1#scrollTo=yPc2mwp1DsML), [NMR](https://colab.research.google.com/drive/1VgLWRLwHGKLyygbZ-9IXuPwiSJelwZqD))
